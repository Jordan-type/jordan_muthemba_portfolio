...
function LastUpdate() {
  return (
    <a
      href="https://github.com/jordan-type/jordan_type"
      target="_blank"
  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Jordan, a <strong>full stack blockchain developer</strong> with a passion for building
        scalable dApps and secure smart contracts.
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://twitter.com/type_jordan"
            target="_blank"
            rel="noreferrer nofollow"
        ...
        <li>
          <a
            href="https://github.com/Jordan-type"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
        ...
        <li>
          <a
            href="https://figma.com/@jordanGreen"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
      ...
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Jordan Type
          </div>
